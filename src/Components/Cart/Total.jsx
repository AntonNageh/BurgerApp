...
const Total = ({finalPrice, setShowAuthModal}) => {
    ...
    return (
       <div className={`${styling.mainTotal} rounded-3xl relative top-0 right-0 m-auto`}>
        ...
        <h1 className='text-center bungee mb-0 bg-gradient-to-r from-yellow-500 via-red-500 to-orange-500 bg-clip-text text-transparent drop-shadow-md'>---------------</h1>
            ...
            <div className='flex flex-col bungee text-sm text-[#fbfada]'>
                ...
                <button onClick={()=> handlePayment()} className='bg-green-500 cursor-pointer hover:bg-green-600 transition-all my-3 rounded-full px-3 py-2'>Confirm payment</button>
